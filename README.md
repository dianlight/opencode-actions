...
| `issue-implementation` | Implement, fix, resolve issues | `north-mini-code-free` | 68.0 | `glm-5.2` | 75.9 |
| `pr-review` | Review PRs, pull requests, diffs | `deepseek-v4-flash-free` | 73.1 | `deepseek-v4-pro` | 83.9 |
| `code-implementation` | Generate code, refactor, implement features | `north-mini-code-free` | 68.0 | `glm-5.2` | 75.9 |
| `frontend-design` | UI design, components, layouts, mockups | `deepseek-v4-flash-free` | 46.9 | `glm-5` | 63.6 |
| `frontend-testing` | Playwright, Cypress, E2E, frontend tests | `north-mini-code-free` | 68.0 | `glm-5.2` | 75.9 |
| `api-testing` | API testing, integration tests, OpenAPI, Postman | `north-mini-code-free` | 68.0 | `glm-5.2` | 75.9 |
...
| `hy3-preview` | Go (Paid) | 55.0 | 50.0 | 60.0 | 40.0 | 55.0 |
...
| `mimo-v2-omni` | Go (Paid) | 60.0 | 46.0 | 66.0 | 55.0 | 58.0 |
| `mimo-v2-pro` | Go (Paid) | 58.4 | 45.5 | 65.8 | 43.6 | 57.8 |
| `mimo-v2.5` | Go (Paid) | 62.0 | 50.0 | 68.0 | 48.0 | 60.0 |
| `mimo-v2.5-free` | Free | 60.0 | 48.0 | 66.0 | 46.0 | 59.0 |
| `mimo-v2.5-pro` | Go (Paid) | 66.0 | 55.0 | 72.0 | 52.0 | 63.0 |
...
| `north-mini-code-free` | Free | 60.0 | 68.0 | 55.0 | 35.0 | 58.0 |
| `qwen3.5-plus` | Go (Paid) | 68.0 | 62.0 | 75.0 | 50.0 | 65.0 |
| `qwen3.6-plus` | Go (Paid) | 70.8 | 64.3 | 77.0 | 52.5 | 67.7 |
| `qwen3.7-max` | Go (Paid) | 75.2 | 60.7 | 82.4 | 58.7 | 76.6 |
| `qwen3.7-plus` | Go (Paid) | 72.0 | 62.0 | 80.0 | 55.0 | 72.0 |

## Workflow Model Audit

> Audited: **2026-07-05 07:01 UTC**
> Workflows checked: **3**
> OpenCode steps found: **3**

| Workflow | Job | Step | Task Type | Current Model | Recommended Free | Recommended Go | Status |
|----------|-----|------|-----------|---------------|------------------|----------------|--------|
| `opencode-implement` | `implement` | `Run opencode (implementation only)` | `issue-implementation` | `opencode/deepseek-v4-flash-free` | `north-mini-code-free` | `glm-5.2` | ⚠️ |
