...
> Last updated: **2026-07-29 00:44 UTC**.
...
| `Code` | Code generation, implementation, refactoring | `kimi-k3` | 72.0 | `deepseek-v4-flash-free` | 57.7 | 🏆 `kimi-k3` | 72.0 |
| `issue-triage` | Triage, label, categorize, route issues | `gemini-3.1-pro` | 79.6 | `deepseek-v4-flash-free` | 69.4 | 🏆 `qwen3.7-max` | 76.6 |
| `issue-implementation` | Implement, fix, resolve issues | `kimi-k3` | 72.0 | `deepseek-v4-flash-free` | 57.7 | 🏆 `kimi-k3` | 72.0 |
| `pr-review` | Review PRs, pull requests, diffs | `gpt-5.5` | 89.5 | `deepseek-v4-flash-free` | 73.1 | 🏆 `deepseek-v4-pro` | 83.9 |
| `code-implementation` | Generate code, refactor, implement features | `kimi-k3` | 72.0 | `deepseek-v4-flash-free` | 57.7 | 🏆 `kimi-k3` | 72.0 |
| `frontend-design` | UI design, components, layouts, mockups | `gpt-5.5` | 76.3 | `mimo-v2.5-free` | 54.0 | 🏆 `glm-5.2` | 63.6 |
| `frontend-testing` | Playwright, Cypress, E2E, frontend tests | `kimi-k3` | 72.0 | `deepseek-v4-flash-free` | 57.7 | 🏆 `kimi-k3` | 72.0 |
| `api-testing` | API testing, integration tests, OpenAPI, Postman | `kimi-k3` | 72.0 | `deepseek-v4-flash-free` | 57.7 | 🏆 `kimi-k3` | 72.0 |
...
| `ling-3.0-flash-free` | Free | ❌ Missing | — | — | — | — | — | — |
...
> Audited: **2026-07-29 00:44 UTC**
> Workflows checked: **3**
> OpenCode steps found: **6**

| Workflow | Job | Step | Task Type | Current Model | Recommended Zen | Recommended Free | Recommended Go | Status |
|----------|-----|------|-----------|---------------|-----------------|------------------|----------------|--------|
| `opencode-issue-handler` | `process-4` | `Run opencode (Process 4 — Issue Review & Refinement)` | `issue-triage` | `opencode/deepseek-v4-flash` | `gemini-3.1-pro` (+15%) | `deepseek-v4-flash-free` | 🏆 `qwen3.7-max` (+10%) | ❌ |
| `opencode-issue-handler` | `process-5` | `Run opencode (Process 5 — Issue Work & PR Creation)` | `issue-implementation` | `opencode/deepseek-v4-flash-free` | `kimi-k3` (+25%) | `deepseek-v4-flash-free` | 🏆 `kimi-k3` (+25%) | ✅ |
...
| `opencode-pr-comment` | `process-6` | `Run opencode (Process 6 — PR Task Execution)` | `code-implementation` | `opencode/kimi-k2.6` | `kimi-k3` (+8%) | `deepseek-v4-flash-free` | 🏆 `kimi-k3` (+25%) | ❌ |
