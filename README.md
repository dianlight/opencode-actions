...
|-------|------|--------|----------|---------|--------|-----------|--------|----------------------|
| `deepseek-v4-flash` | Go (Paid) | ✅ LiveBench | Review, Triage | 67.7 | 57.7 | 73.1 | 46.9 | 69.4 |
| `deepseek-v4-flash-free` | Free | ✅ LiveBench | Review, Triage | 67.7 | 57.7 | 73.1 | 46.9 | 69.4 |
| `deepseek-v4-pro` | Go (Paid) | ✅ LiveBench | Review, Other | 74.4 | 62.0 | 83.9 | 56.4 | 70.3 |
| `glm-5` | Go (Paid) | ✅ LiveBench | Review, Other | 68.7 | 62.5 | 74.0 | 63.6 | 65.0 |
| `glm-5.1` | Go (Paid) | ✅ LiveBench | Review, Other | 70.6 | 63.1 | 75.6 | 60.3 | 69.5 |
| `glm-5.2` | Go (Paid) | ✅ LiveBench | Review, Other | 68.7 | 62.5 | 74.0 | 63.6 | 65.0 |
| `hy3-free` | Free | 📋 Fallback | Review, Triage | 55.0 | 50.0 | 60.0 | 40.0 | 55.0 |
| `hy3-preview` | Go (Paid) | 📋 Fallback | Review, Triage | 55.0 | 50.0 | 60.0 | 40.0 | 55.0 |
| `kimi-k2.5` | Go (Paid) | ✅ LiveBench | Review, Other | 69.2 | 60.1 | 76.7 | 55.0 | 65.3 |
| `kimi-k2.6` | Go (Paid) | ✅ LiveBench | Review, Other | 72.4 | 66.4 | 77.9 | 58.1 | 69.7 |
| `kimi-k2.7-code` | Go (Paid) | 📋 Fallback | Review, Impl | 68.0 | 70.0 | 76.0 | 56.0 | 67.0 |
| `mimo-v2-omni` | Go (Paid) | 📋 Fallback | Review, Other | 60.0 | 46.0 | 66.0 | 55.0 | 58.0 |
| `mimo-v2-pro` | Go (Paid) | ✅ LiveBench | Review, Other | 58.4 | 45.5 | 65.8 | 43.6 | 57.8 |
| `mimo-v2.5` | Go (Paid) | 📋 Fallback | Review, Other | 62.0 | 50.0 | 68.0 | 48.0 | 60.0 |
| `mimo-v2.5-free` | Free | 📋 Fallback | Review, Other | 60.0 | 48.0 | 66.0 | 46.0 | 59.0 |
| `mimo-v2.5-pro` | Go (Paid) | 📋 Fallback | Review, Other | 66.0 | 55.0 | 72.0 | 52.0 | 63.0 |
| `minimax-m2.5` | Go (Paid) | ✅ LiveBench | Review, Triage | 60.3 | 59.3 | 62.3 | 31.3 | 62.2 |
| `minimax-m2.7` | Go (Paid) | ✅ LiveBench | Review, Triage | 65.0 | 52.0 | 72.4 | 34.0 | 67.4 |
| `minimax-m3` | Go (Paid) | ✅ LiveBench | Review, Other | 70.1 | 63.3 | 76.7 | 50.2 | 66.9 |
| `nemotron-3-ultra-free` | Free | ✅ LiveBench | Triage, Impl | 50.7 | 56.5 | 42.9 | 36.5 | 62.5 |
| `north-mini-code-free` | Free | 📋 Fallback | Impl, Code | 60.0 | 68.0 | 55.0 | 35.0 | 58.0 |
| `qwen3.5-plus` | Go (Paid) | 📋 Fallback | Review, Other | 68.0 | 62.0 | 75.0 | 50.0 | 65.0 |
| `qwen3.6-plus` | Go (Paid) | ✅ LiveBench | Review, Other | 70.8 | 64.3 | 77.0 | 52.5 | 67.7 |
| `qwen3.7-max` | Go (Paid) | ✅ LiveBench | Review, Triage | 75.2 | 60.7 | 82.4 | 58.7 | 76.6 |
| `qwen3.7-plus` | Go (Paid) | 📋 Fallback | Review, Triage | 72.0 | 62.0 | 80.0 | 55.0 | 72.0 |

## Workflow Model Audit

> Audited: **2026-07-11 17:39 UTC**
> Workflows checked: **3**
...
| `opencode-issue-handler` | `process-5` | `Run opencode (Process 5 — Issue Work & PR Creation)` | `issue-implementation` | `opencode/north-mini-code-free` | `claude-opus-4-7` (+3%) | 🏆 `north-mini-code-free` | `north-mini-code-free` | ✅ |
...
| `opencode-pr-comment` | `process-6` | `Run opencode (Process 6 — PR Task Execution)` | `code-implementation` | `opencode/north-mini-code-free` | `claude-opus-4-7` (+3%) | 🏆 `north-mini-code-free` | `north-mini-code-free` | ✅ |
